window.addEventListener('load', function() {
  ...
  jsMath.Easy = {
    ...
    //
    root: "/desktop.blocks/i-common/__jsmath/",
  ...
  var easyLoadScript = document.createElement('script');
  easyLoadScript.src = jsMath.Easy.root+'/jsMath-easy-load.js';
  document.body.appendChild(easyLoadScript);
});
