jQuery(document).ready(function($) {
	...
	$('.main-navigation').on( 'click', '.main-navigation-top-level > li > a', function(e){
		...
		if(!$li.hasClass('open')){
			$('.main-navigation, .mobile-filter-actions, .applied-filters').removeClass('open');
		} else {
			$('.main-navigation, .mobile-filter-actions, .applied-filters').addClass('open');
		}
	});
	...
	function wds_ms_update_filter_apply_link() {
		...
		// Setup filter string
		var filter_string = 'http://blogs.microsoft.com/?filter=true';
