...
/***/ function(module, exports, __webpack_require__) {
	...
	shareLinks = {
	    ...
	    readability: {
	        link: 'https://www.readability.com/login/?next=/save?url=%url%',
	        title: 'Readability',
	        js: true,
	        num: 18
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	function ShareBox(sharer) {
	    ...
	    this.template =
	        ...
	        '</div>' +
	        '<div class="pluso-box__link"><a href="http://x.pluso.ru/?newx" target="_blank">Pluso – Кнопки социальных сетей</a></div>' +
	        '</div>' +
	        '</div>';
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/var/www/x.pluso.ru/node_modules/css-loader/index.js!/var/www/x.pluso.ru/src/sharer/themes.css", function() {
			var newContent = require("!!/var/www/x.pluso.ru/node_modules/css-loader/index.js!/var/www/x.pluso.ru/src/sharer/themes.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		module.hot.accept("!!/var/www/x.pluso.ru/node_modules/css-loader/index.js!/var/www/x.pluso.ru/src/sharer/sharer.css", function() {
			var newContent = require("!!/var/www/x.pluso.ru/node_modules/css-loader/index.js!/var/www/x.pluso.ru/src/sharer/sharer.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
		// When the module is disposed, remove the <style> tags
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		module.hot.accept("!!/var/www/x.pluso.ru/node_modules/css-loader/index.js!/var/www/x.pluso.ru/src/sharer/box.css", function() {
			var newContent = require("!!/var/www/x.pluso.ru/node_modules/css-loader/index.js!/var/www/x.pluso.ru/src/sharer/box.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
		// When the module is disposed, remove the <style> tags
