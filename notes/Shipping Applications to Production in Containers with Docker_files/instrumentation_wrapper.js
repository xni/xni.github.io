var SSInstrumentationWrapper = {
  ...
  // tracks an event.
  track : function(experimentName, eventName, eventLabel){
    var experimentConfig = this.experiments[experimentName] || {};
    var eventAction = eventName + '_' + (experimentConfig.bucket || 'out');
    experimentConfig.ga && window._gaq && _gaq.push(['_trackEvent', 'ss_experiment_'+ experimentName, eventAction, eventLabel]);
    experimentConfig.mpq && window.mpq && mpq.track(eventAction);
  },
